...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_ps2_htl_earn_hrs_pre_MODEL")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_ps2_htl_earn_hrs_pre_MODEL", variablesTableName, mainWorkflowId)
...
FROM
  SQ_Shortcut_to_SITE_PROFILE_5 MASTER
...
df_7.createOrReplaceTempView("AGGTRANS_7")

# COMMAND ----------
# DBTITLE 1, EXPTRANS_8
...
df_8.createOrReplaceTempView("EXPTRANS_8")
...
FROM
  ...
  INNER JOIN EXPTRANS_8 DETAIL ON MASTER.STORE_NBR = DETAIL.STORE_NBR
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_ps2_htl_earn_hrs_pre_MODEL")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_ps2_htl_earn_hrs_pre_MODEL", mainWorkflowId, parentName)
