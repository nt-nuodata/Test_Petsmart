...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_ps2_earned_labor_CORE_SQL_NEW_STORE")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_ps2_earned_labor_CORE_SQL_NEW_STORE", variablesTableName, mainWorkflowId)
...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_CURRENCY_DAY_3
...
df_3.createOrReplaceTempView("Shortcut_to_CURRENCY_DAY_3")
...
# COMMAND ----------
# DBTITLE 1, SQ_Shortcut_to_PS2_CORE_EARNED_PRE_6
...
df_6.createOrReplaceTempView("SQ_Shortcut_to_PS2_CORE_EARNED_PRE_6")

# COMMAND ----------
# DBTITLE 1, SQL_INS_and_DUPS_CHECK_7
...
query_7 = f"""SELECT
  ...
  Monotonically_Increasing_Id AS Monotonically_Increasing_Id
FROM
  SQ_Shortcut_to_PS2_CORE_EARNED_PRE_6"""

df_7 = spark.sql(query_7)

df_7.createOrReplaceTempView("SQL_INS_and_DUPS_CHECK_7")

# COMMAND ----------
# DBTITLE 1, EXP_GET_SESSION_INFO_8
...
query_8 = f"""SELECT
  ...
  Monotonically_Increasing_Id AS Monotonically_Increasing_Id
FROM
  SQL_INS_and_DUPS_CHECK_7"""

df_8 = spark.sql(query_8)

df_8.createOrReplaceTempView("EXP_GET_SESSION_INFO_8")
...
df_9.createOrReplaceTempView("AGG_9")

# COMMAND ----------
# DBTITLE 1, EXP_CREATE_INS_SQL_10
...
df_10.createOrReplaceTempView("EXP_CREATE_INS_SQL_10")

# COMMAND ----------
# DBTITLE 1, SQL_INS_to_SQL_TRANSFORM_LOG_11
...
query_11 = f"""SELECT
  ...
  Monotonically_Increasing_Id AS Monotonically_Increasing_Id
FROM
  EXP_CREATE_INS_SQL_10"""

df_11 = spark.sql(query_11)

df_11.createOrReplaceTempView("SQL_INS_to_SQL_TRANSFORM_LOG_11")

# COMMAND ----------
# DBTITLE 1, EXP_ABORT_SESSION_12
...
query_12 = f"""SELECT
  ...
  Monotonically_Increasing_Id AS Monotonically_Increasing_Id
FROM
  SQL_INS_to_SQL_TRANSFORM_LOG_11"""

df_12 = spark.sql(query_12)

df_12.createOrReplaceTempView("EXP_ABORT_SESSION_12")
...
FROM
  EXP_ABORT_SESSION_12""")

# COMMAND ----------
#Post session variable updation
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_ps2_earned_labor_CORE_SQL_NEW_STORE")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_ps2_earned_labor_CORE_SQL_NEW_STORE", mainWorkflowId, parentName)
