...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_ps2_htl_etl_control_EARNED")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_ps2_htl_etl_control_EARNED", variablesTableName, mainWorkflowId)
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_ps2_htl_etl_control_EARNED")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_ps2_htl_etl_control_EARNED", mainWorkflowId, parentName)
