...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_ps2_earned_labor_CA_CORE_SQL")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_ps2_earned_labor_CA_CORE_SQL", variablesTableName, mainWorkflowId)
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_ps2_earned_labor_CA_CORE_SQL")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_ps2_earned_labor_CA_CORE_SQL", mainWorkflowId, parentName)
